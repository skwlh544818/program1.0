...
def plot_picture(history,i):#需要等待
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('fig9/save_loss{}.png'.format(i*10))
...
if __name__ == '__main__':
    ...
    cengshu = [5]
    jiedian = [1500]
    jiedian2=[550,700,710,720,730,740,750,760,770,780,790,800]#[500,510,520,530,540,560,570,580,590,600]#[850,900,950,1000,1100,1200,1300,1400,1500]#[550,600,650,700,750,800]#[250,300,350,400,450,500]#[60,70,80,90,100,150,200]#[3,5,15,25,30,45,50]
    # cengshu = [1]
    # jiedian = [60]-+++++++++++++
